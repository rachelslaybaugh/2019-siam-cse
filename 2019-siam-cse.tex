...
%
\center
\includegraphics[width=0.25\textwidth]{img/particles.png}
%
\pause
%
\begin{columns}
...
\center
\includegraphics[width=\textwidth]{img/pet-spect.jpg}
\end{column}
\begin{column}{0.5\textwidth}
\center
\includegraphics[width=\textwidth]{img/nuclear_dry_storage.jpg}
\end{column}
\end{columns}
%
\end{frame}
...
\begin{column}{0.5\textwidth}
\center
\includegraphics[width=0.7\textwidth]{img/applied-math.jpg}

\includegraphics[width=\textwidth]{img/u235-xsecs.jpg}
\end{column}
\end{columns}
%
\end{frame}
...
\includegraphics[width=\textwidth]{img/ray-effects.png}
\end{column}
\pause
...
\end{column}
\begin{column}{0.4\textwidth}
\includegraphics[width=\textwidth]{img/ray-effects-fine.png}
\end{column}
\end{columns}
%
\end{frame}
...
\begin{columns}
\begin{column}{0.4\textwidth}
\includegraphics[width=\textwidth]{img/ray-effects-ldo.png}
\end{column}
\pause
\begin{column}{0.2\textwidth}
\center\large increasing $N$
...
\end{column}
\begin{column}{0.4\textwidth}
\includegraphics[width=\textwidth]{img/ray-effects-fine-ldo.png}
\end{column}
\end{columns}
%
\end{frame}
...
%
\begin{column}{0.5\textwidth}
\includegraphics[width=\textwidth]{img/exnihilo.png}
\end{column}
\end{columns}
%
\end{frame}
...
%
\begin{column}{0.5\textwidth}
\includegraphics[width=\textwidth]{img/dlvn.png}
\end{column}
\end{columns}
...
%
\centering
\includegraphics[width=\textwidth]{img/DOE-IUP_Logo.png}
%
\end{frame}
